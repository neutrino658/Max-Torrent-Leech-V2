...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1501108805:AAHKDmdzjsJE3VhiKw9E_TQjFjk_bDltPvA")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 2159883))
    API_HASH = os.environ.get("API_HASH", 21e4ac78852e9ace0ccf3a2a4beb994f))
    OWNER_ID = int(os.environ.get("OWNER_ID", 1281593392))
    # Get these values from my.telegram.org
    # to store the channel ID who are authorized to use the bot
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "-519397713").split())
    ...
    DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "MyTorrent")
